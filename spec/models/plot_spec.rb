...
RSpec.describe Plot, type: :model do
  ...
  describe '#organisms_count' do
    it 'returns count of organisms on a particular plot' do
      ...
      org1 = plot.organisms.create!(name: 'Chicken', plant: false, max_size_sqft: 5.0)
      org2 = plot.organisms.create!(name: 'Chicken', plant: false, max_size_sqft: 5.0)
      org3 = plot.organisms.create!(name: 'Rooster', plant: false, max_size_sqft: 5.0)
