...
RSpec.describe Plot, type: :model do
  ...
  before(:each) do
    @plot1 = Plot.create!(name: 'Coop', arable: false, area_sqft: 50.0, created_at: '2020')
    @org1 = @plot1.organisms.create!(name: 'Chicken', plant: false, max_size_sqft: 5.0, alive: true)
    @org2 = @plot1.organisms.create!(name: 'Chicken', plant: false, max_size_sqft: 5.0, alive: false)
    @org3 = @plot1.organisms.create!(name: 'Rooster', plant: false, max_size_sqft: 5.0, alive: true)

    @plot2 = Plot.create!(name: 'Lawn', arable: true, area_sqft: 50.0, created_at: '2023')
    @plot3 = Plot.create!(name: 'Stable', arable: false, area_sqft: 50.0, created_at: '2019')
  end
